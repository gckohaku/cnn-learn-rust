    ...
    T: NNNecessaryTraits,
{
    ...
    fn propagate_grad(
        ...
        let (spread_image, spread_filter) = cnn_transformations::im2col(
            &self.input_of_forward.to_owned().unwrap(),
            &self.filters,
            self.stride,
            self.padding,
        );
        ...
        let reshape_grad_for_filters = spread_grad_for_filters
            .to_shape((
                filters_shape[0],
                filters_shape[1],
                filters_shape[2],
        ...
        let reshape_grad_for_before = cnn_transformations::col2im(
            spread_grad_for_before,
